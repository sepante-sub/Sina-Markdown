...
perpetuity, housed initially at the
1. New Mexico Interstate Stream
Commission Central Office in addition to
1. an off-site copy maintained at
an NMISC field office and mirrored at the Consortium of Universities for
    a. the Advancement of Hydrologic Science (CUAHSI). We will also identify
...
repository. A data policy and stewardship plan will be established. In
    a. addition to archiving, each database table will be exported to a
delimited text format to ensure accessibility of the data by other
1. software programs. The data manager at the NMISC will be responsible for
    a. the management of long-term storage and archived data.
